...
const projects: Project[] = [
  {
    title: 'HireMind',
    description: 'A real-time, voice-driven AI technical interviewer designed to conduct personalized software engineering mock interviews. It analyzes candidates\' GitHub profiles to customize technical questions and conducts low-latency interviews using WebSockets, WebRTC, real-time STT, and TTS, concluding with a comprehensive grading report.',
    tags: ['React 19', 'Express', 'WebSockets', 'Groq AI', 'Deepgram STT/TTS', 'Bun', 'Prisma', 'PostgreSQL', 'Redis', 'Turborepo'],
    category: 'fullstack',
    emoji: '🎙️',
    github: 'https://github.com/mitesh1803/HireMind',
    color: '#6c63ff',
  },
  {
    title: 'Predictify',
    description: 'A decentralized real-time prediction market platform where users can trade shares on event outcomes. Features secure Web3 wallet-based authentication, custom market creation, order matching engine, real-time wallet balance management, and a highly responsive trading dashboard.',
    tags: ['React 19', 'Vite', 'TypeScript', 'Supabase', 'Express 5', 'Bun', 'Drizzle ORM', 'PostgreSQL', 'Turborepo', 'Railway'],
    category: 'fullstack',
    emoji: '📈',
    github: 'https://github.com/mitesh1803/predictify',
    color: '#00d4aa',
  },
  {
    title: 'EchoRTC',
  ...
  },
  {
    ...
    tags: ['TypeScript', 'Node.js', 'Gemini API', 'CLI'],
    category: 'backend',
    emoji: '🤖',
  ...
  },
  {
    ...
    tags: ['TypeScript', 'Node.js', 'Express', 'Chrome Extension'],
    category: 'fullstack',
    emoji: '🔗',
